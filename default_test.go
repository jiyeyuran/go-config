...
import (
	...
	"github.com/jiyeyuran/go-config/source/env"
	"github.com/jiyeyuran/go-config/source/file"
	"github.com/jiyeyuran/go-config/source/memory"
)

func createFileWithContentForTest(t *testing.T, content string) *os.File {
	data := []byte(content)
...
func TestConfigMerge(t *testing.T) {
	fh := createFileWithContentForTest(t, `{
  "amqp": {
